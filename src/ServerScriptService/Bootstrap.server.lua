...
local OrderRPC = require(script.Parent.Systems.OrderRPC)
local CookRPC = require(script.Parent.Systems.CookRPC)
...
task.defer(function() DisasterController:Start() end)
Players.PlayerAdded:Connect(function(plr)
  task.delay(5, function() local profile = PlayerData:Get(plr) or {Level=1}; OrderSystem:SpawnOrder(plr, profile, "Beach") end)
end)
